(function() {
  ...
  describe("Allocation and Deallocation", function() {
    var Pool;
    Pool = require("../utility/ServerPool.js");
    it("Allocation", function() {
      var container1, container2, container3, container4, container5, container6, container7, pool;
      ...
      return expect(container7.length).toBe(0);
    });
    return it("Deallocation", function() {
      var container1, container10, container2, container3, container4, container5, container6, container7, container8, container9, pool;
      pool = new Pool("local", 3, 5);
      container1 = pool.allocate(2, "anderson", "session1");
      container2 = pool.allocate(2, "anderson", "session1");
      container3 = pool.allocate(3, "anderson", "session1");
      ...
      return expect(container10.length).toBe(3);
    });
  });
